...
function getCardDataFromViewElement(viewElement) {
  ...
  return { name: getText(linkElement), tel: getText(telElement), email: linkElement.getAttribute("href").replace(/^mailto:/i, "") };
}
...
class HCardEditing extends Plugin {
  ...
  _defineSchema() {
    this.editor.model.schema.register("h-card", { allowWhere: "$text", isInline: true, isObject: true, allowAttributes: ["email", "name", "tel"] });
  }
  ...
  _defineClipboardInputOutput() {
    ...
    this.listenTo(viewDocument, "clipboardInput", (evt, data) => {
      ...
      writer.appendChild(writer.createElement("span", { class: "h-card" }, [writer.createElement("a", { href: `mailto:${contact.email}`, class: "p-name u-email" }, contact.name), writer.createElement("span", { class: "p-tel" }, contact.tel)]), fragment);
...
export const contacts = [
  { name: "Huckleberry Finn", tel: "+48 1345 234 235", email: "h.finn@example.com" },
  { name: "D'Artagnan", tel: "+45 2345 234 235", email: "dartagnan@example.com" },
  { name: "Little Red Riding Hood", tel: "+45 2345 234 235", email: "lrrh@example.com" },
  { name: "Alice", tel: "+20 4345 234 235", email: "alice@example.com" },
  { name: "Phileas Fogg", tel: "+44 3345 234 235", email: "p.fogg@example.com" },
  { name: "Winnetou", tel: "+44 3345 234 235", email: "winnetou@example.com" },
  { name: "Edmond Dantès", tel: "+20 4345 234 235", email: "count@example.com" },
  { name: "Robinson Crusoe", tel: "+45 2345 234 235", email: "r.crusoe@example.com" },
];

export default HCardEditing;
